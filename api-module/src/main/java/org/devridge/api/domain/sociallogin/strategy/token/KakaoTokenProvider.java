...
@Component
public class KakaoTokenProvider implements OAuth2TokenStrategy {
    ...
    public OAuth2TokenResponse getToken(SocialLoginRequest loginRequest) {
        MultiValueMap<String, String> formData = createKakaoFormData(loginRequest);
    ...
    private MultiValueMap<String, String> createKakaoFormData(SocialLoginRequest loginRequest) {
