...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -1413378179L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRefreshToken refreshToken1 = new QRefreshToken("refreshToken1");

    public final org.devridge.api.domain.member.QAbstractTimeEntity _super = new org.devridge.api.domain.member.QAbstractTimeEntity(this);
